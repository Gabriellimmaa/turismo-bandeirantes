  ...
  return (
    <section className="contato">
      ...
      <div className="pagina">
        ...
        <h3>Endereço</h3>
        <iframe className="mapa"src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAEM-BKN-O6irIoDU8C-G9OFtPUvgb6bjg&q=-23°06'22.9, -50°22'18.7"></iframe>
          <h3>Telefone</h3>
        ...
        <div className="rigth">
          <div className="entreemcontato">
            ...
            <form action="action_page.php">
              ...
              <textarea id="sugestão" name="sugestão" placeholder="Escreva aqui sua sujestão..." style={{ height: '200px' }} defaultValue={""} />
              <input type="enviar" defaultValue="Enviar" />
            </form>
          </div>
        </div>
      </div>
