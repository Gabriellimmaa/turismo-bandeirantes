  ...
  return (
    <div className='historia'>
      ...
      <p><b>Inauguração:</b> 14 de novembro de 1934 <br></br>
        ...
        <b>População:</b> 32.184 (Censo IBGE [2010])<br></br>
        ...
        <b>Clima:</b> Tropical. Verão é longo, quente, abafado e de céu quase encoberto; o inverno é curto, agradável e de céu quase sem nuvens.<br></br>

        <b>Temperatura média:</b> 15°C a 31°C.<br></br>

        <b>Umidade média relativa do ar:</b> 3 a 91%.<br></br>

        <b>Renda per capita (média mensal):</b> 1,9 salários mínimos (IBGE 2020).<br></br>

        <b>Índice de Desenvolvimento Humano (IDH):</b> 0,727 (IBGE 2010)<br></br>

        <b>PIB per capita [2019]:</b> 25.807,42 R$ <br></br>
      ...
      <div className='imagens'>
        ...
        <img className='img' src="src\assets\img\historia\Bandeirantes.png" />
        <h2> Bandeira do município </h2>
        </div>
        <div className='brasao'>
        <img className='img' src="src\assets\img\historia\brasao.png" />
        <h2> Brasão do município </h2>
        </div>
